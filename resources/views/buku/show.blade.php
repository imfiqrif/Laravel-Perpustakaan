            ...
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Detail <b>{{$databuku->judul}}</b> </h4>
                      <form class="forms-sample">

                        <div class="form-group{{ $errors->has('judul') ? ' has-error' : '' }}">
                            <label for="judul" class="col-md-4 control-label">Judul</label>
                            <div class="col-md-6">
                                <input id="judul" type="text" class="form-control" name="judul" value="{{ $databuku->judul }}" readonly="">
                                @if ($errors->has('judul'))
                        ...
                        <div class="form-group{{ $errors->has('npm') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="isbn" type="text" class="form-control" name="isbn" value="{{ $databuku->isbn }}" readonly>
                                @if ($errors->has('isbn'))
                                    <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('pengarang') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="pengarang" type="text" class="form-control" name="pengarang" value="{{ $databuku->pengarang }}" readonly>
                        ...
                        <div class="form-group{{ $errors->has('penerbit') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="penerbit" type="text" class="form-control" name="penerbit" value="{{ $databuku->penerbit }}" readonly>
                        ...
                        <div class="form-group{{ $errors->has('tahun_terbit') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="tahun_terbit" type="number" maxlength="4" class="form-control" name="tahun_terbit" value="{{ $databuku->tahun_terbit }}" readonly>
                        ...
                        <div class="form-group{{ $errors->has('jumlah_buku') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="jumlah_buku" type="number" maxlength="4" class="form-control" name="jumlah_buku" value="{{ $databuku->jumlah_buku }}" readonly>
